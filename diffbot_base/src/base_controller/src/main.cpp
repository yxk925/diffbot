...
Lx98nMotorController motor_controller_right = Lx98nMotorController(MOTOR_RIGHT);
Lx98nMotorController motor_controller_left = Lx98nMotorController(MOTOR_LEFT);

BaseController<Lx98nMotorController, Lx98nMotorDriver> base_controller(nh, &motor_controller_left, &motor_controller_right);
