...
{
    class FakePID : public control_toolbox::Pid
    {
    public:
        /**
         ...
         */
        FakePID(double p=0.0, double i=0.0, double d=0.0, double i_max=0.0, double i_min=0.0, bool antiwindup=false, double out_max=0.0, double out_min=0.0);
